...
function deprecationWarning(inputVer = "1.0.0") {
...
function checkCompatibility(reqVer, supVer) {
...
function packageInstallerErr(error) {
...
function packageInstaller(name, version) {
...
async function getNeanMartPlugin(plugin) {
