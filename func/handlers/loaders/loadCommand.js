...
const SymLock = new Map();

const {  cassWatchJob  } = require("./casswatch.js");
...
const {  extractCommandRole  } = require("../../CommandFiles/modules/unisym.js");
 ...
 * @param {globalThis["Cassidy"]["commands"]} commands
 */
function assignCommand(name, command, commands) {
