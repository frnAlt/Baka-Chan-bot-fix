...
*/
const fs = require("fs");
const UserStatsManager = require("../../handlers/database/handleStat");
const {  init  } = require("../../handlers/database/handleStat");
const {  SymLock  } = require("../loaders/loadCommand.js");
const {  join  } = require("path");
const {  InputRoles  } = require("@cass-modules/InputClass");
const {  extractCommandRole  } = require("@cassidy/unispectra");
...
async function middleware({ allPlugins }) {
  handleStat = init({
