...
const {  parseBet  } = require("@cass-modules/ArielUtils");
...
const { 
  ...
  getTokensInfo,
  updatedTokensInfo,
 } = require("@cass-modules/MTLSUtils");

const isT = global.Cassidy?.config?.gambleNeedsMint ?? false;
