// @ts-check
const {  SpectralCMDHome  } = require("@cassidy/spectral-home");
const {  CassEXP  } = require("../modules/cassEXP.js");
const {  clamp  } = require("../modules/unisym.js");
const {  formatCash  } = require("@cass-modules/ArielUtils");
 ...
 */
function calculateWorthNew(car) {
 ...
 */
function calculateWorth(car, allData) {
