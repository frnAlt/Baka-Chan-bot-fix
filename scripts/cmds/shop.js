...
const {  ReduxCMDHome  } = require("@cassidy/redux-home");
const {  stoData  } = require("../modules/stoData.js");
const {  toTitleCase, UNIRedux  } = require("@cassidy/unispectra");
const {  ShopClass  } = require("../plugins/shopV2.js");
